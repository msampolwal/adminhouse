...
import { ItemDiaComponent } from 'app/entities/item-dia/item-dia.component';
import { ItemDiaService } from 'app/entities/item-dia/item-dia.service';
import { ItemDia } from 'app/shared/model/item-dia.model';

describe('Component Tests', () => {
    describe('ItemDia Management Component', () => {
        let comp: ItemDiaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ItemDiaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.itemDias[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
