...
describe('Service Tests', () => {
    describe('Dia Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DiaService);
        ...
        describe('Service methods', () => {
            ...
            it('should create a Dia', () => {
                service.create(new Dia(null)).subscribe(received => {
            ...
            it('should update a Dia', () => {
                service.update(new Dia(123)).subscribe(received => {
