    ...
    describe('UnidadMedida Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/unidad-medidas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a UnidadMedida', () => {
                service.create(new UnidadMedida(null)).subscribe(received => {
            ...
            it('should update a UnidadMedida', () => {
                service.update(new UnidadMedida(123)).subscribe(received => {
            ...
            it('should return a UnidadMedida', () => {
            ...
            it('should return a list of UnidadMedida', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new UnidadMedida(123)]);
            });
