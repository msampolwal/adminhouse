    ...
    describe('Ingrediente Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/ingredientes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Ingrediente', () => {
                service.create(new Ingrediente(null)).subscribe(received => {
            ...
            it('should update a Ingrediente', () => {
                service.update(new Ingrediente(123)).subscribe(received => {
            ...
            it('should return a Ingrediente', () => {
