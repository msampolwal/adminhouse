...
import { PrecioProductoComponent } from 'app/entities/precio-producto/precio-producto.component';
...
describe('Component Tests', () => {
    describe('PrecioProducto Management Component', () => {
        let comp: PrecioProductoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PrecioProductoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.precioProductos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
