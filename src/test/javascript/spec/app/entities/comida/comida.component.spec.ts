...
import { ComidaComponent } from 'app/entities/comida/comida.component';
import { ComidaService } from 'app/entities/comida/comida.service';
import { Comida } from 'app/shared/model/comida.model';

describe('Component Tests', () => {
    describe('Comida Management Component', () => {
        let comp: ComidaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ComidaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.comidas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
